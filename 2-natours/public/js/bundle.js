...
})(
  {
          ...
          while (sourceIndex < sourceLen) {
            if (sourceIndex in source) {
              ...
              if (spreadable && depth > 0) {
                targetIndex =
                  flattenIntoArray(target, original, element, toLength(element.length), targetIndex, depth - 1) - 1;
              } else {
      ...
      function(require, module, exports) {
        ...
        var login = (exports.login = /*#__PURE__*/ (function() {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(email, password) {
              var res;
                  ...
                  while (1)
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 7:
                        ...
                        (0, _alerts.showAlert)('Error Log out, try again please.');
                      case 10:
                      case 'end':
    ...
    'updateSettings.js': [
      function(require, module, exports) {
        ...
        var updateSettings = (exports.updateSettings = /*#__PURE__*/ (function() {
          var _ref = _asyncToGenerator(
            /*#__PURE__*/ _regeneratorRuntime().mark(function _callee(data, type) {
              var res;
              return _regeneratorRuntime().wrap(
                function _callee$(_context) {
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        return (0, _axios.default)({
                          method: 'PATCH',
                          url: ''.concat(
                            type === 'password' ? 'api/v1/users/update-current-password' : '/api/v1/users/update-me'
                          ),
                          data: data
                        });
                      case 3:
                        res = _context.sent;
                        if (res.data.status === 'success') {
                          (0, _alerts.showAlert)('success', 'Your data is updated!');
                        }
                        _context.next = 10;
                        break;
                      case 7:
                  ...
                  while (1)
                    switch ((_context.prev = _context.next)) {
                      case 0:
                        ...
                        _context.next = 3;
                        return (0, _axios.default)(
                          'http://127.0.0.1:7000/api/v1/bookings/checkout-session/'.concat(tourId)
                        );
                      case 3:
    ...
    'index.js': [
      ...
      },
      {
        ...
        'core-js/modules/es6.array.filter.js': '../../node_modules/core-js/modules/es6.array.filter.js',
        ...
        'core-js/modules/es6.array.map.js': '../../node_modules/core-js/modules/es6.array.map.js',
        'core-js/modules/es6.array.of.js': '../../node_modules/core-js/modules/es6.array.of.js',
        'core-js/modules/es6.array.slice.js': '../../node_modules/core-js/modules/es6.array.slice.js',
